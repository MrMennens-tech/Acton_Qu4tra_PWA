...
4. The board advertises as `blink`, `BLINK`, `blink_q4`, `blink_s1`, or similar
...
- This has been tested against the Qu4tro specifically; it may partially work on other Acton Blink boards (`blink_s1`, `blink_s2`, `blink_lite`) but this is untested
